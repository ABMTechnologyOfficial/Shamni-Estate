...
public class BookedPropertyAdapter extends RecyclerView.Adapter<BookedPropertyAdapter.ViewHolder> {
    ...
    Context context;
    List<BookedPropertyModel.BookedPropertyData> models;

    public BookedPropertyAdapter(Context context, List<BookedPropertyModel.BookedPropertyData> models) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        BookedPropertyModel.BookedPropertyData data = models.get(position);
