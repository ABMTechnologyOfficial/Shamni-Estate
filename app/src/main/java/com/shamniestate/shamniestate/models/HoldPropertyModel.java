...
public class HoldPropertyModel {
    ...
    @SerializedName("Data")
    @Expose
    private List<HoldPropertyData> data;
    ...
    public List<HoldPropertyData> getData() {
        return data;
    }

    public void setData(List<HoldPropertyData> data) {
        this.data = data;
    }


    public class  HoldPropertyData{
