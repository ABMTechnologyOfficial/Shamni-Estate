...
public class VisitorDetailsModel {
    ...
    @SerializedName("Data")
    @Expose
    private List<VisitorDetailsData> data = null;
    ...
    public List<VisitorDetailsData> getData() {
        return data;
    }

    public void setData(List<VisitorDetailsData> data) {
        this.data = data;
    }

    public  class  VisitorDetailsData{
